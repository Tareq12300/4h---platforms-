...
COMPARE_WITH_PREVIOUS_CANDLE = os.environ.get("COMPARE_WITH_PREVIOUS_CANDLE", "true").lower() == "true"
...
def analyze_signal(
    ...
    if (COMPARE_WITH_PREVIOUS_CANDLE and REQUIRE_PRICE_RISING
    ...
    if COMPARE_WITH_PREVIOUS_CANDLE:
